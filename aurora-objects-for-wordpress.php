...
class AuroraObjectsForWordpress {
	...
	function create_admin_menu()
	{
		...
		add_menu_page('Aurora Objects for Wordpress','Aurora Objects for Wordpress','manage_options', 'aws_for_wp', array($this, 'dashboard'), WP_PLUGIN_URL . '/aurora-objects/images/cloudicon.png');
...
// Add Amazon S3 submenu
	...
	function amazon_s3()
	{
		$this->do_redirect(admin_url().'options-general.php?page=aurora-objects/amazon-s3-and-cloudfront/wordpress-s3/class-plugin.php');
	}
