...
/**
 * Class AuroraObjectsForWordpressS3Plugin
 *
 ...
 *
 */
class AuroraObjectsForWordpressS3Plugin extends AuroraObjectsForWordpressS3PluginPublic {

    function AuroraObjectsForWordpressS3Plugin() {
		parent::AuroraObjectsForWordpressS3PluginPublic();
...
//		}
	...
	function addSubMenu()
	{
		add_submenu_page('aws_for_wp', 'Aurora Objects', 'Aurora Objects', 'manage_options', 'aws_for_wp_amazon_s3', array($this, 'admin'));
		$this->version_check();
	}
    ...
    // this should install the javascripts onto the user's o.auroraobjects.eu account
    ...
    function admin() {
        if ( isset( $_POST['action'] ) && $_POST['action'] == 'save' ) {
            ...
            if (function_exists('dns_get_record') && isset( $_POST['options']['virtual-host'] ) && $_POST['options']['virtual-host'] ) {
                ...
                if (($record[0]['type'] != 'CNAME') || ($record[0]['target'] != $_POST['options']['bucket'].'o.auroraobjects.eu')) {
                    $error = "Warning: Your DNS doesn't seem to be setup correctly to virtually host the domain <em>".$_POST['options']['bucket']."</em>. ".
						...
						"<br /><br />".
                        "<code>".$_POST['options']['bucket']." CNAME ".$_POST['options']['bucket'].".o.auroraobjects.eu.</code>".
						"<br /><br />".
	...
	*/
    ...
    function get_access_domain() {
    	...
    	elseif ( isset($this->options['virtual-host']) && $this->options['virtual-host'] ) {
			...
			return $this->options['bucket'].'.o.auroraobjects.eu';
        }
    }
    ...
    function isPublic($key) {
        $everyone = 'http://o.auroraobjects.eu/groups/global/AllUsers';
